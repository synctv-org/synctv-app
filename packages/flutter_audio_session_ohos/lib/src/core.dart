...
class AudioSession {
  ...
  final _ohosAudionManager =
      !kIsWeb && Platform.operatingSystem.toLowerCase() == 'ohos'
          ? OhosAudioManager()
          : null;
  ...
  Future<bool> setActive(
    ...
    } else if (!kIsWeb && Platform.operatingSystem.toLowerCase() == 'ohos') {
...
class AudioSessionConfiguration {
  ...
  AudioSessionConfiguration.fromJson(Map<String, dynamic> data)
      : this(
          ...
          ohosAudioAttributes: data['ohosAudioAttributes'] == null
              ? null
              : OhosAudioAttributes.fromJson(
                  (data['ohosAudioAttributes'] as Map<dynamic, dynamic>)
                      .cast<String, dynamic>()),
        );
  ...
  const AudioSessionConfiguration.music()
      : this(
          ...
          ohosAudioAttributes: const OhosAudioAttributes(
  ...
  const AudioSessionConfiguration.speech()
      : this(
          ...
          ohosAudioAttributes: const OhosAudioAttributes(
            streamUsage: StreamUsage.audioBook,
          ),
        );
  ...
  AudioSessionConfiguration copyWith({
    ...
    OhosAudioAttributes? ohosAudioAttributes,
      ...
      AudioSessionConfiguration(
        ...
        ohosAudioAttributes: ohosAudioAttributes ?? this.ohosAudioAttributes,
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        'ohosAudioAttributes': ohosAudioAttributes?.toJson(),
      };
}
