...
class GetDirectUrlHlsSegmentRequest extends $pb.GeneratedMessage {
  factory GetDirectUrlHlsSegmentRequest({
    $core.String? version,
  ...
  GetDirectUrlHlsSegmentRequest._();

  factory GetDirectUrlHlsSegmentRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory GetDirectUrlHlsSegmentRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'GetDirectUrlHlsSegmentRequest',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'synctv.playback_provider.direct_url'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'version')
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetDirectUrlHlsSegmentRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetDirectUrlHlsSegmentRequest copyWith(
          void Function(GetDirectUrlHlsSegmentRequest) updates) =>
      super.copyWith(
              (message) => updates(message as GetDirectUrlHlsSegmentRequest))
          as GetDirectUrlHlsSegmentRequest;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static GetDirectUrlHlsSegmentRequest create() =>
      GetDirectUrlHlsSegmentRequest._();
  @$core.override
  GetDirectUrlHlsSegmentRequest createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static GetDirectUrlHlsSegmentRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetDirectUrlHlsSegmentRequest>(create);
  static GetDirectUrlHlsSegmentRequest? _defaultInstance;
...
class DirectUrlHlsSegmentResponse extends $pb.GeneratedMessage {
  factory DirectUrlHlsSegmentResponse({
    $0.StreamChunk? chunk,
  }) {
    final result = create();
    if (chunk != null) result.chunk = chunk;
  ...
  DirectUrlHlsSegmentResponse._();

  factory DirectUrlHlsSegmentResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory DirectUrlHlsSegmentResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'DirectUrlHlsSegmentResponse',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'synctv.playback_provider.direct_url'),
      createEmptyInstance: create)
    ..aOM<$0.StreamChunk>(1, _omitFieldNames ? '' : 'chunk',
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  DirectUrlHlsSegmentResponse clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  DirectUrlHlsSegmentResponse copyWith(
          void Function(DirectUrlHlsSegmentResponse) updates) =>
      super.copyWith(
              (message) => updates(message as DirectUrlHlsSegmentResponse))
          as DirectUrlHlsSegmentResponse;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static DirectUrlHlsSegmentResponse create() =>
      DirectUrlHlsSegmentResponse._();
  @$core.override
  DirectUrlHlsSegmentResponse createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static DirectUrlHlsSegmentResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<DirectUrlHlsSegmentResponse>(create);
  static DirectUrlHlsSegmentResponse? _defaultInstance;
...
class DirectUrlPlaybackProviderServiceApi {
  ...
  $async.Future<DirectUrlHlsSegmentResponse> getHlsSegment(
          $pb.ClientContext? ctx, GetDirectUrlHlsSegmentRequest request) =>
      _client.invoke<DirectUrlHlsSegmentResponse>(
          ctx,
          'DirectUrlPlaybackProviderService',
          'GetHlsSegment',
          request,
          DirectUrlHlsSegmentResponse());
