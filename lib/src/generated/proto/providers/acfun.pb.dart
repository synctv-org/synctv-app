...
class ResolveResponse extends $pb.GeneratedMessage {
  factory ResolveResponse({
    ...
    $0.AcFunMediaSourceConfig? sourceConfig,
  }) {
    final result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$0.AcFunMediaSourceConfig>(4, _omitFieldNames ? '' : 'sourceConfig',
        subBuilder: $0.AcFunMediaSourceConfig.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(4)
  $0.AcFunMediaSourceConfig get sourceConfig => $_getN(3);
  @$pb.TagNumber(4)
  set sourceConfig($0.AcFunMediaSourceConfig value) => $_setField(4, value);
  @$pb.TagNumber(4)
  $core.bool hasSourceConfig() => $_has(3);
  @$pb.TagNumber(4)
  void clearSourceConfig() => $_clearField(4);
  @$pb.TagNumber(4)
  $0.AcFunMediaSourceConfig ensureSourceConfig() => $_ensure(3);
}
