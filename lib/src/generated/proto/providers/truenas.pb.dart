...
class FileItem extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$0.DiscoveredSource>(17, _omitFieldNames ? '' : 'source',
  ...
  @$pb.TagNumber(17)
  $0.DiscoveredSource get source => $_getN(16);
  @$pb.TagNumber(17)
  set source($0.DiscoveredSource value) => $_setField(17, value);
  @$pb.TagNumber(17)
  $core.bool hasSource() => $_has(16);
  @$pb.TagNumber(17)
  void clearSource() => $_clearField(17);
  @$pb.TagNumber(17)
  $0.DiscoveredSource ensureSource() => $_ensure(16);
}
