...
class LoginResponse extends $pb.GeneratedMessage {
  factory LoginResponse({
    ...
    if (quotaTotal != null) result.quotaTotal = quotaTotal;
    if (quotaUsage != null) result.quotaUsage = quotaUsage;
    return result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aInt64(6, _omitFieldNames ? '' : 'quotaTotal')
    ..aInt64(7, _omitFieldNames ? '' : 'quotaUsage')
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(6)
  $fixnum.Int64 get quotaTotal => $_getI64(5);
  @$pb.TagNumber(6)
  set quotaTotal($fixnum.Int64 value) => $_setInt64(5, value);
  @$pb.TagNumber(6)
  $core.bool hasQuotaTotal() => $_has(5);
  @$pb.TagNumber(6)
  void clearQuotaTotal() => $_clearField(6);

  @$pb.TagNumber(7)
  $fixnum.Int64 get quotaUsage => $_getI64(6);
  @$pb.TagNumber(7)
  set quotaUsage($fixnum.Int64 value) => $_setInt64(6, value);
  @$pb.TagNumber(7)
  $core.bool hasQuotaUsage() => $_has(6);
  @$pb.TagNumber(7)
  void clearQuotaUsage() => $_clearField(7);
}

class UnlockLibraryRequest extends $pb.GeneratedMessage {
  factory UnlockLibraryRequest({
    $core.String? serverId,
  ...
  UnlockLibraryRequest._();

  factory UnlockLibraryRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory UnlockLibraryRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'UnlockLibraryRequest',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'synctv.provider.seafile'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'serverId')
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  UnlockLibraryRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  UnlockLibraryRequest copyWith(void Function(UnlockLibraryRequest) updates) =>
      super.copyWith((message) => updates(message as UnlockLibraryRequest))
          as UnlockLibraryRequest;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static UnlockLibraryRequest create() => UnlockLibraryRequest._();
  @$core.override
  UnlockLibraryRequest createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static UnlockLibraryRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<UnlockLibraryRequest>(create);
  static UnlockLibraryRequest? _defaultInstance;
...
class UnlockLibraryResponse extends $pb.GeneratedMessage {
  factory UnlockLibraryResponse({
    $core.bool? success,
  }) {
    final result = create();
  ...
  UnlockLibraryResponse._();

  factory UnlockLibraryResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory UnlockLibraryResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'UnlockLibraryResponse',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'synctv.provider.seafile'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  UnlockLibraryResponse clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  UnlockLibraryResponse copyWith(
          void Function(UnlockLibraryResponse) updates) =>
      super.copyWith((message) => updates(message as UnlockLibraryResponse))
          as UnlockLibraryResponse;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static UnlockLibraryResponse create() => UnlockLibraryResponse._();
  @$core.override
  UnlockLibraryResponse createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static UnlockLibraryResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<UnlockLibraryResponse>(create);
  static UnlockLibraryResponse? _defaultInstance;
...
class ListRepositoriesRequest extends $pb.GeneratedMessage {
  ...
  ListRepositoriesRequest._();

  factory ListRepositoriesRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ListRepositoriesRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ListRepositoriesRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class ListStarredRequest extends $pb.GeneratedMessage {
  factory ListStarredRequest({
    $core.String? serverId,
    $fixnum.Int64? page,
    $core.int? pageSize,
    $core.String? instanceName,
  ...
  ListStarredRequest._();

  factory ListStarredRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ListStarredRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ListStarredRequest',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'synctv.provider.seafile'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'serverId')
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ListStarredRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ListStarredRequest copyWith(void Function(ListStarredRequest) updates) =>
      super.copyWith((message) => updates(message as ListStarredRequest))
          as ListStarredRequest;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static ListStarredRequest create() => ListStarredRequest._();
  @$core.override
  ListStarredRequest createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static ListStarredRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ListStarredRequest>(create);
  static ListStarredRequest? _defaultInstance;
...
class FileItem extends $pb.GeneratedMessage {
  factory FileItem({
    ...
    $core.bool? repositoryEncrypted,
    $core.bool? passwordRequired,
    $0.DiscoveredSource? source,
  }) {
    final result = create();
    if (repositoryId != null) result.repositoryId = repositoryId;
    if (repositoryName != null) result.repositoryName = repositoryName;
    if (path != null) result.path = path;
    ...
    if (repositoryEncrypted != null)
      result.repositoryEncrypted = repositoryEncrypted;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(2, _omitFieldNames ? '' : 'repositoryName')
    ..aOS(3, _omitFieldNames ? '' : 'path')
    ..aOS(4, _omitFieldNames ? '' : 'name')
    ..aOS(5, _omitFieldNames ? '' : 'objectId')
    ..aOB(6, _omitFieldNames ? '' : 'isDir')
    ..a<$fixnum.Int64>(7, _omitFieldNames ? '' : 'size', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..aOS(8, _omitFieldNames ? '' : 'modifiedAt')
    ..aOS(9, _omitFieldNames ? '' : 'permission')
    ..aOS(10, _omitFieldNames ? '' : 'modifierName')
    ..aOB(11, _omitFieldNames ? '' : 'starred')
    ..aOB(12, _omitFieldNames ? '' : 'hasThumbnail')
    ..aOB(13, _omitFieldNames ? '' : 'repositoryEncrypted')
    ..aOB(14, _omitFieldNames ? '' : 'passwordRequired')
    ..aOM<$0.DiscoveredSource>(15, _omitFieldNames ? '' : 'source',
  ...
  @$pb.TagNumber(2)
  $core.String get repositoryName => $_getSZ(1);
  @$pb.TagNumber(2)
  set repositoryName($core.String value) => $_setString(1, value);
  @$pb.TagNumber(2)
  $core.bool hasRepositoryName() => $_has(1);
  @$pb.TagNumber(2)
  void clearRepositoryName() => $_clearField(2);
  ...
  @$pb.TagNumber(8)
  $core.String get modifiedAt => $_getSZ(7);
  @$pb.TagNumber(8)
  set modifiedAt($core.String value) => $_setString(7, value);
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  $core.String get permission => $_getSZ(8);
  @$pb.TagNumber(9)
  set permission($core.String value) => $_setString(8, value);
  @$pb.TagNumber(9)
  $core.bool hasPermission() => $_has(8);
  @$pb.TagNumber(9)
  void clearPermission() => $_clearField(9);

  @$pb.TagNumber(10)
  $core.String get modifierName => $_getSZ(9);
  @$pb.TagNumber(10)
  set modifierName($core.String value) => $_setString(9, value);
  @$pb.TagNumber(10)
  $core.bool hasModifierName() => $_has(9);
  @$pb.TagNumber(10)
  void clearModifierName() => $_clearField(10);

  @$pb.TagNumber(11)
  $core.bool get starred => $_getBF(10);
  @$pb.TagNumber(11)
  set starred($core.bool value) => $_setBool(10, value);
  @$pb.TagNumber(11)
  $core.bool hasStarred() => $_has(10);
  @$pb.TagNumber(11)
  void clearStarred() => $_clearField(11);

  @$pb.TagNumber(12)
  $core.bool get hasThumbnail => $_getBF(11);
  @$pb.TagNumber(12)
  set hasThumbnail($core.bool value) => $_setBool(11, value);
  @$pb.TagNumber(12)
  $core.bool hasHasThumbnail() => $_has(11);
  @$pb.TagNumber(12)
  void clearHasThumbnail() => $_clearField(12);

  @$pb.TagNumber(13)
  $core.bool get repositoryEncrypted => $_getBF(12);
  @$pb.TagNumber(13)
  set repositoryEncrypted($core.bool value) => $_setBool(12, value);
  @$pb.TagNumber(13)
  $core.bool hasRepositoryEncrypted() => $_has(12);
  @$pb.TagNumber(13)
  void clearRepositoryEncrypted() => $_clearField(13);

  @$pb.TagNumber(14)
  $core.bool get passwordRequired => $_getBF(13);
  @$pb.TagNumber(14)
  set passwordRequired($core.bool value) => $_setBool(13, value);
  @$pb.TagNumber(14)
  $core.bool hasPasswordRequired() => $_has(13);
  @$pb.TagNumber(14)
  void clearPasswordRequired() => $_clearField(14);

  @$pb.TagNumber(15)
  $0.DiscoveredSource get source => $_getN(14);
  @$pb.TagNumber(15)
  set source($0.DiscoveredSource value) => $_setField(15, value);
  @$pb.TagNumber(15)
  $core.bool hasSource() => $_has(14);
  @$pb.TagNumber(15)
  void clearSource() => $_clearField(15);
  @$pb.TagNumber(15)
  $0.DiscoveredSource ensureSource() => $_ensure(14);
}
