...
import 'acfun.pb.dart' as $0;

export 'package:protobuf/protobuf.dart' show GeneratedMessageGenericExtensions;

class AcFunProviderServiceApi {
  final $pb.RpcClient _client;

  AcFunProviderServiceApi(this._client);

  $async.Future<$0.ResolveResponse> resolve(
          $pb.ClientContext? ctx, $0.ResolveRequest request) =>
      _client.invoke<$0.ResolveResponse>(ctx, 'AcFunProviderService', 'Resolve',
