...
class _TikTokAddMediaFormState extends State<TikTokAddMediaForm> {
  ...
  Future<tiktok.GetUserResponse> _resolveUser(TikTokAddRequest request) {
    ...
    return SyncTvService.getTikTokUser(
    ...
    try {
      ...
      if (_mode == TikTokAddMode.userPosts) {
        ...
        _posts = list != null
            ...
            : await SyncTvService.listTikTokUserPosts(
                _user!.secUid,
                pageSize: 1,
                instanceName: request.instanceName,
              );
        ...
        _resolved = resolve != null
            ...
            : await SyncTvService.resolveTikTok(
                request.value,
                instanceName: request.instanceName,
              );
      }
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      MessageUtils.showSuccess(context, 'TikTok source added');
      setState(() {});
    } catch (error) {
      if (mounted) MessageUtils.showError(context, '$error');
    } finally {
