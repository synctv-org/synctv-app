...
import 'package:synctv_app/models/twitch_source_config.dart';
...
class _TwitchAddMediaFormState extends State<TwitchAddMediaForm> {
  ...
  Future<void> _loadCategories() async {
    await _run(() async {
      ...
      _categories = load != null
          ? await load(_request)
          : await SyncTvService.listTwitchTopCategories(
              pageSize: 50,
              instanceName: _instanceName,
            );
    });
      ...
      switch (_mode) {
        case TwitchAddMode.media:
          ...
          _resolved = resolve != null
              ...
              : await SyncTvService.resolveTwitch(
                  request.resource,
        ...
        case TwitchAddMode.channel:
          ...
          _channelItems = list != null
              ...
              : await SyncTvService.listTwitchChannelItems(
                  channel,
        ...
        case TwitchAddMode.followedLive:
          ...
          _followedLive = list != null
              ? await list(request)
              : await SyncTvService.listTwitchFollowedLive(
                  pageSize: 8,
                  instanceName: request.instanceName,
                );
        case TwitchAddMode.categoryLive:
          ...
          _categoryStreams = list != null
              ? await list(request)
              : await SyncTvService.listTwitchCategoryStreams(
        ...
        case TwitchAddMode.searchLive:
          ...
          _searchResults = search != null
              ...
              : await SyncTvService.searchTwitchLiveChannels(
                  request.resource,
                  pageSize: 8,
                  instanceName: request.instanceName,
                );
  ...
  Future<void> _loadSchedule(String broadcasterId) async {
    await _run(() async {
      ...
      _schedule = load != null
          ...
          : await SyncTvService.listTwitchSchedule(
              broadcasterId,
              pageSize: 8,
              instanceName: _instanceName,
            );
  ...
  Future<void> _submit() async {
    ...
    await _run(() async {
      ...
      MessageUtils.showSuccess(context, 'Twitch source added');
    });
  }
